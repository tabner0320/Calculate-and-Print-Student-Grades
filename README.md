...
This project is a C# console application that calculates the total sum of assignment scores for a group of students and displays the results.
 ...
 Uses C# variables and arithmetic operations to process data.
 Formats output clearly in the console.

 How to Run
1. Install [.NET SDK](https://dotnet.microsoft.com/download) 
2. Clone this repository. ( https://github.com/tabner0320/Calculate-and-Print-Student-Grades.git)
